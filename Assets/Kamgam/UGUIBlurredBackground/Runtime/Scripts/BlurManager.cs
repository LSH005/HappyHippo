...
namespace Kamgam.UGUIBlurredBackground
{
    ...
    public class BlurManager
    {
        ...
        public Texture GetBlurredTexture(RenderMode renderMode, BlurredBackgroundImage image)
        {
            return Renderer.GetBlurredTexture(renderMode, image);
        }
